...
//tuong tu, ham nay khong can thay doi, chi can hieu de hien thi vi tri cac layout
@SuppressWarnings("serial")
public class AReturnVehiclePagePane<T> extends JPanel {

    public AReturnVehiclePagePane(AReturnVehicleSearchPane searchPane, AReturnVehicleListPane<T> listPane) {
