...
public class Station {
	...
	/*
	 * static Station fromJson(Map<String, String> json) { return new Station(
	 * json.get("id"), json.get("name"), json.get("name"),
	 ...
	 * + "StationAdsress: " + this.stationAddress; }
	 */
	public boolean match(Station station) {
		 ...
		 * return false; } if (station.numberEBikes != 0 && this.numberEBikes !=
		 * station.numberEBikes) { return false; } if (station.numberEmptyDocks != 0 &&
		 * this.numberEmptyDocks != station.numberEmptyDocks) { return false; } if
		 * (station.numberTwinBikes != 0 && this.numberTwinBikes !=
		 * station.numberTwinBikes) { return false; } if (station.stationDistance != 0
		 * && this.stationDistance != station.stationDistance) { return false; } if
		 * (station.stationTime != 0 && this.stationTime != station.stationTime) {
		 * return false; }
		 */
